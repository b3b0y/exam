...
if(isset($_POST['submit']) && $_POST['submit'] == 'Save')
{
    ...
    mysql_query("INSERT INTO question_category(subject_id,name,description,image_url) VALUES('".$_POST['subj']."','".$_POST['name']."','".$_POST['descrip']."','".$image_url."')") or die('Error: '. mysql_error());

    move_uploaded_file($_FILES['photo']['tmp_name'], $image_url);

    echo "<script> alert('Successfully saved'); window.location.href='../pages/questions_category.php' </script>";
}
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form method="post" enctype="multipart/form-data" action="question_category_form.php" role="form">
