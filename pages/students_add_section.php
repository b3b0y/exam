...
{
    mysql_query("UPDATE student_section SET section_id = '".$_POST['section']."' WHERE user_id = '".$_POST['user']."'");

    header("Location: print_section.php?user=".$_POST['user']."");
}
    ...
    <div id="wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                    <br>
                        <a  class="hide-from-printer" href="students_result.php"><button class="hide-from-printer"  type="button">Back</button></a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                               ...
                               <center>
                                ...
                                <div class="row show-grid">
                                    ...
                                    <div class="table-responsive">
                                         <?php
                                            ...
                                            <?php
                                                    ...
                                                    $result4 = mysql_query("SELECT * from student_section as ssec, users  WHERE ssec.user_id = users.id  AND user_id = '".$_GET['user']."'") or die("Error: ". mysql_error());
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <input class="hide-from-printer" type="submit" value="ADD" name="print">
                                    </div>
                                    <!-- /.table-responsive -->
                                  </form>
                                </div>
