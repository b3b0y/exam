...
if(isset($_REQUEST['restore'])){
    ...
    if($extension == 'sql')
    {
        ...
        echo "<script> alert('Successfully Restored'); window.location.href='../pages/index.php?db=true' </script>";
    }
    else
    {
        echo "<script> alert('Please Select Database file'); window.location.href='../pages/index.php?db=true' </script>";
    }
}
